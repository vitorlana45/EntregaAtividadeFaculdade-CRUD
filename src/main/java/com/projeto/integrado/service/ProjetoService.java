...
public class ProjetoService {
	...
	public Projeto projetoDescricao(String descricao) {
		return projetoRepository.findByProjetoDescricao(descricao).orElseThrow(() -> new EntityNotFoundException("recurso nao encontrado"));
	}
}