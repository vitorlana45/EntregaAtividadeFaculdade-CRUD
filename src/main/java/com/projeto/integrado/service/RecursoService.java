...
public class RecursoService {
	...
	public Recurso getRecurso(String nomeRecurso) {
		return recursoRepository.findByRecursoNome(nomeRecurso).orElseThrow(() -> new EntityNotFoundException("recurso noa enconrado"));
	}
